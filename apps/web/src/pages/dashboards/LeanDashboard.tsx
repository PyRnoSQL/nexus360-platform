...
export const LeanDashboard = ({ user }) => {
  const { t } = useTranslation();
  const userRole = user?.role;
  const dashboardKey = 'lean';
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white mb-2">{t('dashboard.lean')}</h1>
        <p className="text-gray-400">Amélioration continue et performance institutionnelle</p>
      </div>
      <DashboardEmbed 
