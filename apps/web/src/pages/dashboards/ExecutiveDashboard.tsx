...
export const ExecutiveDashboard = ({ user }) => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white mb-2">{t('dashboard.executive')}</h1>
        <p className="text-gray-400">Indicateurs stratégiques et performance globale</p>
      </div>
      <DashboardEmbed 
