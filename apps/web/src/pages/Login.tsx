...
export const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (password === '1234' && ['dg', 'cd', 'op', 'admin'].includes(username.toLowerCase())) {
        const roleMap = { op: 'OFFICIER', admin: 'SUPER_ADMIN', cd: 'COMMISSAIRE', dg: 'DG' };
        const nameMap = { op: 'Officier', admin: 'Super Administrateur', cd: 'Commissaire', dg: 'Délégué Général' };
        onLogin({ id: '1', username, role: roleMap[username], name: nameMap[username] });
      } else {
        setError('Identifiants invalides');
      }
    }
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        {/* Logo - Cameroon logo with transparent background */}
        ...
        {/* Powered by - Outside the rectangle */}
